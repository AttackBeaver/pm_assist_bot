...
async def cmd_help(message: Message) -> None:
    await message.answer(
        ...
        "<b>Статистика и мотивация:</b>\n"
        "• /stats — ваша статистика\n"
        "• /achievements — достижения\n"
        "• /deadlines — ближайшие дедлайны\n"
        "• /recommendations — рекомендации по курсам\n\n"

        "<b>Встречи и расшифровка:</b>\n"
        "• Отправьте <b>ссылку на Яндекс Телемост</b> в любой чат — я автоматически запишу встречу (60 секунд), распознаю речь и создам задачи.\n"
        "• Нажмите кнопку <b>«📞 Встреча»</b> — появятся альтернативные способы (загрузить файл, ссылка на Яндекс.Диск, mymeet.ai, Playwright).\n\n"
